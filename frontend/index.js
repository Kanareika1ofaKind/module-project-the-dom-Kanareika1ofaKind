...
authorDate.textContent = `${author} in ${date || " unknown date"}`;
...
const smashWords = `We need to ${randomVerb1} our ${randomNoun1} ${randomAdverb1} in order to ${randomVerb2} our ${randomNoun2} ${randomAdverb2}.`;
const paragraph = document.createElement('p');
paragraph.textContent = smashWords; 
